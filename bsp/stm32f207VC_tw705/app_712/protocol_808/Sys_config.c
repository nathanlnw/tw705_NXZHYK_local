...
u8		RemoteIP_main[4] = {111, 113, 20, 220}; //{111,113,14,154}; 宁夏北星         111.113.20.220 中科应发
u16		RemotePort_main = 9131; //山西中航北斗   7000
u8		RemoteIP_aux[4] = {60, 28, 50, 210}; //{60,28,50,210}
u16		RemotePort_aux = 4000;
//           Link2  Related
u8      Remote_Link2_IP[4] = {111, 113, 20, 220};
...
void  Vehicleinfo_Init(void)
{
    ...
    Vechicle_Info.Dev_ProvinceID = 64; //   64: 宁夏
    Vechicle_Info.Dev_CityID = 181;    //  灵武市 181
...
u8     JT808_Conf_init( void )
{
    ...
    //  定时拍照间隔
    JT808Conf_struct.take_Duration = 1200; // ACC  开启 后 20 min 拍照且有速度
...
void DefaultConfig(void)
{
    ...
    rt_kprintf("\r\n        触发上报传感器为  TriggerSDsatus=%X    定时拍照间隔=%d s  \r\n", TriggerSDsatus, JT808Conf_struct.take_Duration);
